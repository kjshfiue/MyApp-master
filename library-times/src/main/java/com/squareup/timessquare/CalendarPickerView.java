...
public class CalendarPickerView extends ListView {
    ...
    public CalendarPickerView(Context context, AttributeSet attrs) {
        ...
        displayMonth = a.getBoolean(R.styleable.CalendarPickerView_tsquare_displayMonth, true);
    ...
    public Date getLastSelectedDate() {
        return (selectedCals.size() > 0 ? selectedCals.get(selectedCals.size() - 1).getTime() : null);
    }
    ...
    private class MonthAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            monthView.setTitleVisibility(displayMonth);
