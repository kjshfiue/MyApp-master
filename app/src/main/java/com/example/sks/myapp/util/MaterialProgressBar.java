...
public class MaterialProgressBar extends View {
    ...
    private int fanTextColor = Color.parseColor("#404040"); //进度数字颜色
    ...
    private void init() {
        ...
        fanPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        fanPaint.setColor(fanTextColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCurMode == Mode.INDETERMINATE) {
            ...
            canvas.rotate(90, mBounds.centerX(), mBounds.centerY());
            String content = String.valueOf((int) (mProgress * 100));
            canvas.drawText(content, mBounds.centerX() - fanPaint.measureText(content) / 2, mBounds.centerY() + fanPaint.measureText(content, 0, 1) / 2, fanPaint);
        }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        fanPaint.setTextSize(mBounds.width() / 3);
