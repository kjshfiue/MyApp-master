...
public class MonthView extends LinearLayout {
    ...
    public static MonthView create(ViewGroup parent, LayoutInflater inflater,
                                   Listener listener, Calendar today, DayViewAdapter adapter) {

        return create(parent, inflater, new SimpleDateFormat("EEE",Locale.getDefault()), listener, today, Color.TRANSPARENT,
                Color.WHITE, Color.GRAY, Color.BLACK, true, Color.BLACK, null,
                Locale.getDefault(), adapter);
    }
